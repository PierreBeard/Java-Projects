...
public class addmono_popup {

	public static int compteur =3;
	
	public addmono_popup(){
		...
		popup.setTitle("Ajouter un moniteur à la base");
		...
		text.setText("Ajouter un moniteur");	
		text.setFont(font1);
		...
		text5.setText("Choisir la couleur : ");	
		text5.setFont(font2);
        ...
        String listeCouleur[] = {"Bleu","Rouge","Noir","Blanc"};
        JComboBox couleur = new JComboBox(listeCouleur);  
        couleur.setBounds(0,0,210,20);
        couleur.setMaximumRowCount(3);
    	couleur.setLocation(210, 160);
    	panel.add(couleur);
	    ...
	    valider.addActionListener(new Actionlistenvalidate(popup,usernameField,surnameField, ageField, couleur,Main.lechemincourant));
	    panel.add(valider);    
...
class Actionlistencancel implements ActionListener{
    ...
    class Actionlistenvalidate implements ActionListener{
        ...
        Actionlistenvalidate(JFrame laf,JTextField usernam,JTextField surnam,JTextField ag,JComboBox couleu, String s ){
                this.fo = laf;    
        ...
        @Override
		public void actionPerformed(ActionEvent e) {
        	Color coule=new Color(0,0,0);
        	
        	if(this.couleur.getSelectedIndex()==0)
        		coule=Color.blue;
        	if(this.couleur.getSelectedIndex()==1)
        		coule=Color.red;
        	if(this.couleur.getSelectedIndex()==2)
        		coule=Color.black;
        	if(this.couleur.getSelectedIndex()==3)
        		coule=Color.white;       	
        	
        	Moniteur mono = new Moniteur(this.username.getText(),this.surname.getText(),Integer.valueOf(this.age.getText()),coule, Main.lechemincourant);
			Main.liste_mono.add(mono);
